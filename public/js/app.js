...
/* harmony import */ var toast_me__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! toast-me */ "./node_modules/toast-me/lib/toast-me.min.js");
/* harmony import */ var toast_me__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(toast_me__WEBPACK_IMPORTED_MODULE_3__);
...
window.toast = (toast_me__WEBPACK_IMPORTED_MODULE_3___default());
var options = {
  position: 'bottom'
};
Livewire.on('itemAdd', function (post) {
  toast_me__WEBPACK_IMPORTED_MODULE_3___default()("Item agredado exitosamente! " + post.title, options);
});
Livewire.on('itemChange', function (post) {
  toast_me__WEBPACK_IMPORTED_MODULE_3___default()("Item modificado exitosamente! " + post.title, options);
});
Livewire.on('itemDelete', function () {
  toast_me__WEBPACK_IMPORTED_MODULE_3___default()("Item elimado :(", 'error');
});
